...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-center pt-8 sm:justify-start sm:pt-0 px-5">
            ...
            <div class="ml-4 text-lg font-semibold" style="font-size: 1.6rem;">Awesome App 🤩
            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://salla.partners" class="underline text-gray-900 dark:text-white">Salla Partner Portal</a></div>
                    </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://salla.dev" class="underline text-gray-900 dark:text-white">Salla Blog</a></div>
                    </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://docs.salla.dev" class="underline text-gray-900 dark:text-white">API Documentation</a></div>
                    </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white"><a href="https://t.me/salladev" class="underline text-gray-900 dark:text-white">{{ '</Salla Developers>' }}</a></div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            </Salla Developers>The official Salla Developers Telegram channel where anyone may discuss technical questions and get answers. Salla Team will use this channel to share technical articles, news, tutorials, development ideas, and more. This community will also be used to communicate regular announcements and updates.                        </div>
                    </div>
                </div>
            </div>
        </div>
